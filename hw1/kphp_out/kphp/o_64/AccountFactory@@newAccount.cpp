...
//30: throw new Exception('Invalid account type.');
      {
        {
          THROW_EXCEPTION (f$_exception_set_location(f$Exception$$__construct(class_instance<C$Exception>().alloc(), v$const_string$us9fcbae9d722e8efe), v$const_string$us96377ddff2b9434b, 30_i64));
          return {};
        }
        ;
      }
